...
//                .setName("§7" + Lang.get("Animation_Radius") + ": §e" + menu.getEditor().getEffectPortal().getTeleportRadius())
...
//                }
//
//                updateDisplayName(getItem(2), "§7" + Lang.get("Teleport_Radius") + ": §e" + menu.getEditor().getEffectPortal().getTeleportRadius());
//            }
//
//            @Override
...
//                .setName("§7" + Lang.get("Animation_Height") + ": §e" + menu.getEditor().getEffectPortal().getAnimationHeight())
//                .getItem(), new ItemListener() {
//            @Override
//            public void onClick(HotbarGUI gui, ItemComponent ic, Player player, ClickType clickType) {
//                //Animation-Height
...
//                }
//
//                updateDisplayName(getItem(3), "§7" + Lang.get("Animation_Height") + ": §e" + menu.getEditor().getEffectPortal().getAnimationHeight());
//            }
//
//            @Override
//            public void onHover(HotbarGUI gui, ItemComponent old, ItemComponent current, Player player) {
...
//                .setName("§7" + Lang.get("Animation_Type") + ": '§e" + menu.getEditor().getEffectPortal().getAnimationType().name() + "§7'")
//                .getItem(), new ItemListener() {
//            @Override
//            public void onClick(HotbarGUI gui, ItemComponent ic, Player player, ClickType clickType) {
//                //Animation-Type
...
//                }
//
//                updateDisplayName(getItem(4), "§7" + Lang.get("Animation_Type") + ": '§e" + menu.getEditor().getEffectPortal().getAnimationType().name() + "§7'");
//            }
//
//            @Override
//            public void onHover(HotbarGUI gui, ItemComponent old, ItemComponent current, Player player) {
...
//        }));
//
//        String s = menu.getEditor().getEffectPortal().getParticle().getName();
...
//                }
//
//                String s_ = menu.getEditor().getEffectPortal().getParticle().getName();
