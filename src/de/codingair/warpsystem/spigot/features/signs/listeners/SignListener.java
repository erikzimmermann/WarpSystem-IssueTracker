...
public class SignListener implements Listener {
    ...
    public void onPlace(SignChangeEvent e) {
        ...
        if(e.getLine(0).equalsIgnoreCase("[warps]")) {
            Bukkit.getScheduler().runTaskLater(WarpSystem.getInstance(), () -> new WarpSignGUI(e.getPlayer(), new WarpSign(Location.getByLocation(e.getBlock().getLocation()))).open(), 1L);
