...
public class PEffectPortals extends PageItem {
    ...
    public PEffectPortals(Player p, EffectPortalsOptions options) {
        super(p, Editor.TITLE_COLOR + "WarpSystem§r §7- §6" + Lang.get("Config"), new ItemBuilder(XMaterial.BLAZE_ROD).setName(Editor.ITEM_TITLE_COLOR + Lang.get("Effect_Portals")).getItem(), false);
