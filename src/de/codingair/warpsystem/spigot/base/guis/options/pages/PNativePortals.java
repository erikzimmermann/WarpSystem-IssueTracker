...
import de.codingair.warpsystem.spigot.base.utils.options.specific.NativePortalsOptions;
import org.bukkit.entity.Player;
import org.bukkit.event.inventory.InventoryClickEvent;
import org.bukkit.inventory.ItemStack;

public class PNativePortals extends PageItem {
    private NativePortalsOptions options;

    public PNativePortals(Player p, NativePortalsOptions options) {
        super(p, Editor.TITLE_COLOR + "WarpSystem§r §7- §6" + Lang.get("Config"), new ItemBuilder(XMaterial.END_PORTAL_FRAME).setName(Editor.ITEM_TITLE_COLOR + Lang.get("NativePortals")).getItem(), false);
